...
\begin{document}
	...
	\begin{enumerate}
		...
		\[
			F_m = max\left(-\frac{M_l}{r}, min\left(\frac{M_l}{r}, \frac{M_l}{r} * \frac{k_p \cdot \left(e(t_e) + \frac{1}{T_i} \sum_{i = 0}^{n - 1} e(i \cdot t_s) + T_d \frac{e(t_e) - e(t_e - t_s)}{t_s} \right)}{v_s}\right)\right)
		\]
